...
export const DocumentUploadDialog: React.FC<DocumentUploadDialogProps> = ({
  ...
  const handleFileSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const validFiles = files.filter(
      (file) =>
        validTypes.has(file.type) || /\.(pdf|doc|docx|txt|html|png|jpg|jpeg)$/i.test(file.name)
    );

    if (validFiles.length !== files.length) {
      setUploadStatus({ status: 'warning', message: 'Some files were not supported and were skipped.' });
    }
  ...
  const handleSubmit = async () => {
    setUploadStatus({ status: 'uploading', message: 'Processing documents...' });
    ...
    try {
      ...
      const res = (await onUpload(documents)) as { nodeCount?: number; summaries?: unknown[] };
      ...
      setUploadStatus({ status: 'success', message: 'Ingestion completed successfully.' });
  ...
  return (
    <Dialog open={isOpen}>
      <DialogContent className="max-w-4xl w-full force-light" onClose={handleClose}>
        <DialogHeader>
          <DialogTitle>Upload Documents</DialogTitle>
          <DialogDescription>
            Upload files or create a document. Add metadata and tags for better organization.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-gray-500">PDF, DOC/DOCX, TXT, HTML, PNG, JPG</div>
              </div>
            </Button>
            ...
            >
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-gray-500">Use the rich text editor</div>
              </div>
            </Button>
          </div>
        ) : (
          <div className="space-y-6">
              ...
              <div>
                ...
                >
                  <div className="flex flex-col items-center">
                    ...
                    <div className="text-xs text-gray-500 mt-1">You can select multiple files</div>
                  </div>
                </Button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select value={department} onValueChange={setDepartment} placeholder="Select Department">
                  <SelectTrigger />
                  <SelectContent>
              ...
              <div className="space-y-2">
                ...
                <Select value={documentType} onValueChange={setDocumentType} placeholder="Select Type">
                  <SelectTrigger />
                  <SelectContent>
            ...
            <div className="space-y-2">
              ...
              {tagArray.length > 0 && (
                <div className="flex flex-wrap gap-2">
                  {tagArray.map((t, i) => (
                    <Badge key={`${t}-${i}`} className="capitalize">{t}</Badge>
                  ))}
                </div>
              )}
            </div>
