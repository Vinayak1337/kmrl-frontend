...
export default function LandingPage() {
	...
	const useCases = {
		procurement: {
			...
			surfacedAction: 'Enforce two-packet technical tender rules for tenders > ₹50 Lakhs'
		},
		legal: {
			tabLabel: 'Legal',
	...
	const pipelineSteps = [
		...
		},
		{
			...
			description: 'Segment long manuals into sequential linked nodes preserving section hierarchies and technical parameters.'
		},
		{
			number: '03',
			title: 'Muse Spark Intelligence',
			description: 'OpenCode Zen reasoning model extracts decisions, deadlines, compliance liabilities, and responsible owners.'
		},
		{
			number: '04',
	...
	return (
		<div className='min-h-screen bg-[#F8F9FA] text-[#111827] flex flex-col selection:bg-[#EEF2FF] selection:text-[#1E1B4B]'>
			{/* PUBLIC TOP NAVIGATION */}
			<nav className='h-18 bg-white/90 backdrop-blur-md border-b border-[#E5E7EB] sticky top-0 z-50 px-6 sm:px-12 flex items-center justify-between'>
				<div className='flex items-center gap-3'>
					<DocSetuLogo size='md' />
					<span className='hidden sm:inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-[#E6F4F1] border border-[#BCE3DA] text-[11px] font-medium text-[#0F766E]'>
						<Cpu className='h-3 w-3 text-[#0F766E]' />
						<span>OpenCode Zen · Muse Spark 1.3</span>
					</span>
				</div>
			...
			<main className='flex-1 space-y-28 py-16 sm:py-24 px-6 sm:px-12 max-w-7xl mx-auto w-full'>
				...
				<section className='space-y-12'>
					<div className='grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center'>
						...
						<div className='lg:col-span-6 space-y-6'>
							<div className='inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-[#E5E7EB] text-[11px] font-semibold text-[#4B5563] uppercase tracking-[0.12em] shadow-2xs'>
							...
							<div className='flex flex-wrap items-center gap-3 pt-3'>
								...
								<a
									href='#pipeline'
									className='inline-flex items-center gap-2 px-5 py-3 rounded-full bg-white border border-[#E5E7EB] text-xs font-semibold text-[#111827] hover:bg-[#F3F4F6] hover:border-[#D1D5DB] transition-all shadow-2xs'>
								...
								<div className='card-bezel-inner p-5 sm:p-6 space-y-5'>
									...
									<div className='flex items-center justify-between pb-3 border-b border-[#F0F2F5]'>
										...
										<span className='text-[10px] font-mono text-[#9CA3AF] uppercase tracking-wider'>
											docsetu-query-engine // muse-spark-1.3
										</span>
									</div>

									{/* Query Pill */}
									<div className='p-3.5 bg-[#F8F9FA] rounded-2xl border border-[#E5E7EB] flex items-center justify-between gap-3'>
										...
										<div className='w-6 h-6 rounded-full bg-[#111827] text-white flex items-center justify-center flex-shrink-0'>
									...
									<div className='space-y-3 pt-1'>
										...
										<div className='p-4 rounded-2xl border border-[#E5E7EB] bg-[#FFFFFF] space-y-2 shadow-2xs hover:border-[#3B49DF]/40 transition-colors'>
											<div className='flex items-center justify-between'>
												<span className='text-xs font-bold text-[#111827]'>
													Commercial Retail Concession - Edapally Station
												</span>
												<span className='px-2.5 py-0.5 rounded-full bg-[#FEF3C7] text-[#92400E] text-[10px] font-semibold tracking-wide'>
													Due 18 Sep 2026
												</span>
											</div>
											...
											<div className='flex items-center gap-2 pt-1 text-[11px] text-[#9CA3AF] font-mono'>
												<span className='text-[#3B49DF] font-semibold'>Legal</span>
												<span>/</span>
										...
										<div className='p-4 rounded-2xl border border-[#E5E7EB] bg-[#FFFFFF] space-y-2 shadow-2xs hover:border-[#3B49DF]/40 transition-colors'>
											<div className='flex items-center justify-between'>
												...
												<span className='px-2.5 py-0.5 rounded-full bg-[#E6F4F1] text-[#0F766E] text-[10px] font-semibold tracking-wide'>
													Dual Sign-off
												</span>
											</div>
											<p className='text-xs text-[#4B5563] leading-relaxed'>
											...
											<div className='flex items-center gap-2 pt-1 text-[11px] text-[#9CA3AF] font-mono'>
												<span className='text-[#3B49DF] font-semibold'>Procurement</span>
												<span>/</span>
				...
				<section id='pipeline' className='space-y-12 pt-8'>
					<div className='text-center space-y-3 max-w-2xl mx-auto'>
						<div className='inline-block px-3 py-1 rounded-full bg-[#EEF2FF] text-[#3B49DF] text-[10px] font-semibold uppercase tracking-[0.15em]'>
						...
						{pipelineSteps.map((step, idx) => (
							<div
								...
								<div className='card-bezel-inner p-5 space-y-3'>
									<div className='text-xs font-mono font-bold text-[#3B49DF]'>
										{step.number}
									</div>
				...
				<section className='space-y-10'>
					<div className='space-y-3 text-center max-w-2xl mx-auto'>
						<div className='inline-block px-3 py-1 rounded-full bg-[#E6F4F1] text-[#0F766E] text-[10px] font-semibold uppercase tracking-[0.15em]'>
							Functional Domains
						</div>
						<h2 className='text-3xl sm:text-4xl font-extrabold text-[#111827] tracking-tight'>
							...
							<button
								...
								className={`px-4 py-2 rounded-full text-xs font-medium transition-all ${
									activeUseCase === k
										...
										: 'bg-white border border-[#E5E7EB] text-[#4B5563] hover:bg-[#F3F4F6] hover:text-[#111827]'
								}`}>
								{useCases[k].tabLabel}
							</button>
						))}
					...
					<div className='card-bezel max-w-4xl mx-auto'>
						<div className='card-bezel-inner p-6 sm:p-8 space-y-6'>
							<div className='space-y-2'>
								<div className='text-[10px] font-mono font-semibold text-[#9CA3AF] uppercase tracking-wider'>
									Query Prompt
								</div>
							...
							<div className='p-5 rounded-2xl bg-[#F8F9FA] border border-[#E5E7EB] space-y-3'>
								<div className='text-[10px] font-mono font-semibold text-[#0F766E] uppercase tracking-wider flex items-center gap-1.5'>
									<Sparkles className='h-3.5 w-3.5 text-[#0F766E]' />
									<span>Synthesized Answer (Muse Spark 1.3)</span>
								</div>
							...
							<div className='grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2'>
								<div className='space-y-2'>
									...
									<div className='space-y-1.5'>
										{useCases[activeUseCase].sources.map((s, idx) => (
											<div
												key={idx}
												className='flex items-center gap-2 p-2.5 rounded-xl bg-white border border-[#E5E7EB] text-xs font-medium text-[#111827]'>
												<BookOpen className='h-3.5 w-3.5 text-[#3B49DF] flex-shrink-0' />
								...
								<div className='space-y-2'>
									...
									<div className='p-3.5 rounded-xl bg-[#FEF3C7] border border-[#FDE68A] text-xs text-[#92400E] font-medium leading-relaxed'>
			...
			{/* FOOTER */}
			<footer className='border-t border-[#E5E7EB] bg-white py-12 px-6 sm:px-12 text-xs text-[#6B7280]'>
				<div className='max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4'>
					...
					<div className='flex items-center gap-6'>
						<span className='text-[11px] font-mono'>Powered by OpenCode Zen (Muse Spark 1.3 Free)</span>
