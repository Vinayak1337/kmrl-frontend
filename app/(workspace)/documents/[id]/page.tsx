...
export default function DocumentDetailPage({
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-7 p-5 sm:p-8 lg:p-10">
      ...
      {/* HEADER BLOCK */}
      <div className="space-y-5 border-b border-border-default pb-5">
        ...
        {viewMode === "tabs" ? (
          <div className="flex border-b border-[#E1E4DF] gap-6 pt-2 text-xs font-semibold overflow-x-auto">
            {(
              ["overview", "sections", "actions", "source", "activity"] as const
            ).map((tab) => (
              <button
                key={tab}
          ...
          <div className="pt-3 flex items-center justify-between text-xs text-[#677080] border-t border-[#E1E4DF]">
            ...
            <span className="hidden sm:inline">
              Cross-referencing section text against extracted actions &
              intelligence
            </span>
          </div>
        )}
            ...
            <div className="space-y-4 border-t border-border-strong pt-5">
              <div className="flex items-center justify-between">
                <h3 className="text-sm font-semibold text-[#172033] flex items-center gap-2">
                  ...
                  <span>
                    Extracted Obligations ({document.actions?.length || 0})
                  </span>
                </h3>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-6">
                ...
                {document.risks && document.risks.length > 0 && (
                  <div className="space-y-2.5 border-l-2 border-red-300 py-1 pl-4">
                ...
                <div className="space-y-4 border-t border-border-strong pt-5 text-xs">
              ...
              <div className="lg:col-span-8 bg-white rounded-xl border border-[#E1E4DF] p-6 shadow-2xs space-y-6">
                {activeSection ? (
                  <>
                    <div className="flex items-center justify-between border-b border-[#E1E4DF] pb-4">
                      <div>
                        ...
                        <p className="text-xs text-[#9098A5]">
                          Pages {activeSection.pageRange.start}–
                          {activeSection.pageRange.end}
                        </p>
                      </div>
                    ...
                    {/* Affected Teams */}
                    {activeSection.affectedTeams &&
                      activeSection.affectedTeams.length > 0 && (
                        <div className="space-y-2">
                          <h4 className="text-xs font-semibold text-[#172033] uppercase tracking-wider">
                            Affected Teams
                          </h4>
                    ...
                    {activeSection.sourceContent && (
                      <details className="pt-4 border-t border-[#E1E4DF]">
                        <summary className="text-xs font-semibold text-[#4656D9] cursor-pointer hover:underline">
                          View Source Text (Pages{" "}
                          {activeSection.pageRange.start}–
                          {activeSection.pageRange.end})
                        </summary>
            ...
            <div className="bg-white rounded-xl border border-[#E1E4DF] p-6 shadow-2xs space-y-6">
              <div>
                ...
                <p className="text-xs text-[#677080] mt-0.5">
                  Responsibilities, compliance deadlines, and procedural changes
                  extracted by DocSetu
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                {document.actions.filter((a) => a.type === "action").length ===
                0 ? (
            ...
            <div className="bg-white rounded-xl border border-[#E1E4DF] p-6 shadow-2xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-[#E1E4DF]">
                <div>
                  ...
                  <p className="text-xs text-[#677080]">
                    Original text preservation for auditability and source
                    grounding
                  </p>
                </div>
                {document.rawUrl && (
